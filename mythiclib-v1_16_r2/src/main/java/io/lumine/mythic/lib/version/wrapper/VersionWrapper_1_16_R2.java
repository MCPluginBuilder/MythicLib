...
public class VersionWrapper_1_16_R2 implements VersionWrapper {
    ...
    public static class NBTItem_v1_16_R2 extends NBTItem {
    ...
    private static class NBTCompound_v1_16_R2 extends NBTCompound {
        private final NBTTagCompound compound;
    ...
    public void setUUID(Player player, UUID uniqueId) {
        ...
        final var gameProfile = handle.getProfile();
        try {
